...
class AlphabetPop {
  constructor(container, appCtrl) {
    ...
    // Vocabulary DB
    this.VOCAB_DB = {
      'A': [{ word: 'Apple', image: 'img/vocab/a.svg' }],
      'B': [{ word: 'Bear', image: 'img/vocab/b.svg' }],
      'C': [{ word: 'Cat', image: 'img/vocab/c.svg' }],
      'D': [{ word: 'Dog', image: 'img/vocab/d.svg' }],
      'E': [{ word: 'Elephant', image: 'img/vocab/e.svg' }],
      'F': [{ word: 'Fox', image: 'img/vocab/f.svg' }],
      'G': [{ word: 'Giraffe', image: 'img/vocab/g.svg' }],
      'H': [{ word: 'Horse', image: 'img/vocab/h.svg' }],
      'I': [{ word: 'Ice cream', image: 'img/vocab/i.svg' }],
      'J': [{ word: 'Juice', image: 'img/vocab/j.svg' }],
